# FigureS9_auxinDegron.R -----------------------------------------------------
# Author:      JP Flores
# Date:        2026-04-23
# Project:     STRS
# Description: Supplementary figure S9 showing CTCF/RAD21 auxin-inducible
...
output_file  <- file.path(project_dir, "figures/FigureS9.pdf")
