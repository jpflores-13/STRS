...
## Save plotCovariate plots
pdf("plots/matchRanges_covariate_agg_contacts.pdf", width = 6, height = 5)
plotCovariate(nullSet)
dev.off()

pdf("plots/matchRanges_covariate_loop_size.pdf", width = 6, height = 5)
plotCovariate(nullSet, covar = "loop_size")
dev.off()

## Save plotPropensity plot
pdf("plots/matchRanges_propensity.pdf", width = 6, height = 5)
...
## Print number of gained loops for manuscript
...
pdf("plots/aggregatedTADs_gained.pdf", width=8, height=6)
(aggTAD_gainedPlot <- plotAggTAD(aggtad_gain,maxval = aggtad_gain[26,75]*1.2))
dev.off()

pdf("plots/aggregatedTADs_matched.pdf", width=8, height=6)
(aggTAD_matchedPlot <-plotAggTAD(aggtad_match,maxval = aggtad_match[26,75]*1.2))
dev.off()

#------------------------- Plot TAD enrichment ---------------------#

pdf("plots/tad_enrichment.pdf", width=8, height=6)
...
pdf("plots/loop_enrichment.pdf", width=8, height=6)
