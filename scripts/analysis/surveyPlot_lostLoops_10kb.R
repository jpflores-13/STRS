# ##############################################################################
# filename:    surveyPlot_lostLoops_10kb.R
# author:      JP Flores
# project:     STRS
# date:        2026-04-02
# description: Survey plots for top 100 lost differential loops; two Hi-C
...
output_pdf     <- "plots/surveyPlot_lostLoops_10kb.pdf"
n_loops        <- 100L
buffer         <- 200e3
page_width     <- 5.75
page_height    <- 5.5
