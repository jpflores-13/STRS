# domainAnalysis_YAPdTAD.R ------------------------------------------------
# Author:      JP Flores
# Date:        2026-04-19
# Project:     STRS
# Description: Visualizes changes in 3D chromatin domain organization between
#              untreated and 1h sorbitol-treated HEK293T eGFP-YAPdTAD cells.
#              Mirrors domainAnalysis.R exactly but reads from YAPdTAD-specific
#              insulation, eigenvector, and saddle outputs produced by
#              domain_analysis_YAPdTAD.sh.
# Input:       data/processed/hic/insulation_YAPdTAD/*.tsv
#              data/processed/hic/eigenvectors_YAPdTAD/*.tsv
#              data/processed/hic/eigenvectors_YAPdTAD/*.saddledata.tsv
# Output:      plots/YAPdTAD/*.pdf
#              data/processed/hic/domain_rds_YAPdTAD/*.rds
# -------------------------------------------------------------------------
...
insulation_dir <- file.path(project_dir, "data/processed/hic/insulation_YAPdTAD")
eigvec_dir     <- file.path(project_dir, "data/processed/hic/eigenvectors_YAPdTAD")
output_dir     <- file.path(project_dir, "plots/YAPdTAD")
rds_dir        <- file.path(project_dir, "data/processed/hic/domain_rds_YAPdTAD")
...
resolution    <- 10e3       # 10 kb — resolution of insulation scores
...
## Insulation score TSVs — one row per 10 kb genomic bin
...
## Saddle data TSVs — (n_bins+2) x (n_bins+2) including outlier bins
...
compartment_levels <- c("B \u2192 B (stable)", "A \u2192 A (stable)",
                        "B \u2192 A", "A \u2192 B")
