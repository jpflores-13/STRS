...
# Setting static and gained loops -------------------------------------------
...
##make pdf
pdf(file = "plots/exampleRegion_gained.pdf",
    width = 5.75,
    height = 5.75)
...
annoHighlight(
  plot = control,
  fill = "lightgrey",
  chrom = as.character(seqnames(loopRegions_gained))[38],
  chromstart = start(loopRegions_gained)[38],
  chromend = start(loopRegions_gained)[38] + 10e3,
  default.units = "inches",
...
annoHighlight(
  ...
  fill = "lightgrey",
  chrom = as.character(seqnames(loopRegions_gained))[38],
  chromstart = end(loopRegions_gained)[38],
  chromend = end(loopRegions_gained)[38] - 10e3,
  default.units = "inches"
)
