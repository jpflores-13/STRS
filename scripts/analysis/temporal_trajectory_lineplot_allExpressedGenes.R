# Transcriptional Response at Differential Loop Anchors - All Expressed Genes
...
# Extract ALL genes from the DESeq2 object (not filtered by LRT significance)
...
# Key difference: NO filtering by padj_lrt
...
ggsave(
  "plots/temporal_trajectory_lineplot_allExpressedGenes.pdf",
  plot = line_plot,
  width = 8,
  height = 6,
  units = "in"
