# ##############################################################################
# filename:    surveyPlot_gainedLoops_rnaTimecourse_10kb.R
# author:      JP Flores
# project:     STRS
# date:        2026-04-02
# description: Survey plots for top 100 gained loops with RNA-seq timecourse
...
output_pdf     <- "plots/surveyPlot_gainedLoops_rnaTimecourse_10kb.pdf"
n_loops        <- 100L
buffer         <- 200e3
page_width     <- 5.75
page_height    <- 9.1

# YlGnBu palette for timecourse: 0h, 1h, 3h, 6h, 9h, 12h, 24h
