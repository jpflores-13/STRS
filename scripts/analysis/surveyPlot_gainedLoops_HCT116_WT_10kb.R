## Gained differential loop visualizations (HiC rectangles) - HCT116 WT
...
## make pdf
pdf(file = "plots/surveyPlot_gainedLoops_HCT116_WT_10kb.pdf",
    width = 5.75,
    height = 5.5)
...
for(i in seq_along(loopRegions_gained_buffed)){
  ...
  ## Plot top Hi-C rectangle (HCT116 WT control)
  
  control <- plotHicRectangle(data = hic_files$hct116_control,
                              params = p,
                              y = 0.5)
  ...
  ## Plot bottom Hi-C rectangle (HCT116 WT sorbitol 1h)
  
  sorb <- 
    plotHicRectangle(data = hic_files$hct116_sorbitol, 
                     params = p,
                     y = 2.6)
  ...
  plotText(label = "HCT116 WT control",
           x = 0.25,
           y = 0.5,
           just = c("top", "left"))
  
  plotText(label = "HCT116 WT + sorbitol (1h)",
           x = 0.25,
           y = 2.6,
           just = c("top", "left"))
